...
const FinancePage = () => {
  ...
  const { 
    ...
    defaultDescription: 'Track your income, expenses, and farm profitability'
  });
  ...
  const [forecastDescription, setForecastDescription] = useState('Simulate different scenarios to anticipate your financial situation');
  ...
  const handleImportConfirm = (importType: string) => {
    ...
    toast.success("Data import successful", {
      description: `${importType} data has been successfully imported`
    });
  };
  ...
  const handleAddIncome = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("Income added", {
        description: "New income has been successfully added"
      });
    }, 1000);
  };
  ...
  const handleActivateModule = (moduleName: string) => {
    toast.success(`${moduleName} module activated`, {
      description: `The ${moduleName.toLowerCase()} module has been successfully activated`
    });
  };
      ...
      content: (
        <div className="p-6 bg-white rounded-xl border">
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Title updated", {
                  description: "Income section title has been modified"
                });
              }}
            />
          </h2>
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Description updated", {
                  description: "Income section description has been modified"
                });
              }}
            />
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => handleCardDetailClick('CAP')}>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg flex items-center">
                  <Badge className="mr-2 bg-blue-100 text-blue-800 hover:bg-blue-200">Subsidies</Badge> 
                  CAP
                </CardTitle>
                <CardDescription>Agricultural aids and subsidies</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => handleCardDetailClick('Other income')}>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg flex items-center">
          ...
          <h2 className="text-xl font-bold mb-4 flex items-center">
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Title updated", {
                  description: "Expenses section title has been modified"
                });
              }}
            />
          </h2>
          <p className="text-muted-foreground mb-6">
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Description updated", {
                  description: "Expenses section description has been modified"
                });
              }}
            />
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => handleCardDetailClick('Seeds & Fertilizers')}>
              <CardHeader className="pb-2">
                ...
                <CardDescription>Purchases for production</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <h2 className="text-xl font-bold mb-4 flex items-center">
              ...
              <EditableField
                ...
                onSave={(value) => {
                  ...
                  toast.success("Title updated", {
                    description: "Forecasts section title has been modified"
                  });
                }}
              />
            </h2>
            <p className="text-muted-foreground mb-6">
              <EditableField
                ...
                onSave={(value) => {
                  ...
                  toast.success("Description updated", {
                    description: "Forecasts section description has been modified"
                  });
                }}
              />
            </p>
          ...
          <h2 className="text-xl font-bold mb-4 flex items-center">
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Title updated", {
                  description: "Budget section title has been modified"
                });
              }}
            />
          </h2>
          <p className="text-muted-foreground mb-6">
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Description updated", {
                  description: "Budget section description has been modified"
                });
              }}
            />
          </p>
          ...
          <h2 className="text-xl font-bold mb-4 flex items-center">
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Title updated", {
                  description: "Reports section title has been modified"
                });
              }}
            />
          </h2>
          <p className="text-muted-foreground mb-6">
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Description updated", {
                  description: "Reports section description has been modified"
                });
              }}
            />
          </p>
