...
const parcelData: ParcelDetail = {
  ...
  irrigationSystem: 'Tube well irrigation with canal water backup',
  notes: 'High-yielding wheat variety field. Excellent soil fertility with good drainage.',
  owner: 'Punjab Agricultural Cooperative Society',
...
const initialTasks: TaskData[] = [
  ...
  {
    id: 5,
    task: 'Wheat harvesting preparation',
    dueDate: '2024-04-10',
    assignedTo: 'Rajesh Kumar',
    priority: 'High',
    status: 'To Do'
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-muted/30 p-4 rounded-lg">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <span className="ml-1 text-xl">acres</span>
                </div>
              </div>
...
export default IndianParcelDetail;