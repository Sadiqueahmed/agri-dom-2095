...
const StatisticsHeader = () => {
  ...
  const handleExport = async () => {
    try {
      console.log("Exporting statistics as CSV...");
  ...
  const handleShareByEmail = () => {
    console.log("Preparing to share by email...");
  ...
  return (
    <header className="flex flex-col mb-6 gap-4">
      <div>
        <h1 className="text-xl md:text-2xl font-bold mb-1 text-gray-800">Statistics and Analysis</h1>
        <p className="text-sm md:text-base text-gray-500">View and analyze your farm data</p>
      </div>
